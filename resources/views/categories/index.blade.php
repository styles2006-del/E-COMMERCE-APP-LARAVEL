@extends('layouts.admin.base', [
    'page_title' => 'Categories | liste',
])
@section('content')
    <div class="min-w-6xl max-w-7xl space-y-12">
        <div class="flex justify-between">
            <h1 class="text-3xl">Liste des Catégories</h1>
            ...
            <table class="w-full">
                <thead>
                    <tr class="border-b border-gray-300">
                        ...
                        <th class="text-left text-sm px-3 py-2">Total Articles</th>
                ...
                <tbody>
                    @forelse ($categories as $categorie)
                        <tr class="border-t border-gray-300 hover:bg-gray-200">
                            <td class="text-left text-sm px-3 py-2">{{ $categorie->id }}</td>
                            <td class="text-left text-sm px-3 py-2">{{ $categorie->label }}</td>
                            <td class="text-left text-sm px-3 py-2">{{ $categorie->description }}</td>
                            <td>
